...
export function LandingNav() {
  ...
  return (
    <>
      ...
      />
      <header
        className={`fixed left-1/2 top-4 z-50 flex w-[min(1280px,95vw)] -translate-x-1/2 items-center gap-8 rounded-lg border border-white/[.12] bg-void/70 px-6 py-3 shadow-lift backdrop-blur-xl transition-transform duration-500 [transition-timing-function:cubic-bezier(.2,.7,.2,1)] ${
