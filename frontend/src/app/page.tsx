...
function Shell({ children }: { children: React.ReactNode }) {
  return <div className="mx-auto w-full max-w-[1280px] px-6">{children}</div>;
}
  ...
  return (
    <main className="relative bg-void text-on-dark">
      ...
      <div className="relative z-10">
        ...
        {/* 2 · SOCIAL PROOF */}
        <section aria-label="Social proof" className="border-y border-white/[.07] py-16">
          <Shell>
            <FadeIn>
        ...
        <section id="how" className="border-t border-white/[.07] py-24">
          <Shell>
            <SectionHead
              kicker="How it works"
        ...
        {/* 5 · PRICING */}
        <section id="pricing" className="border-t border-white/[.07] py-24">
          <Shell>
            <SectionHead
              kicker="Pricing"
        ...
        {/* 6 · TESTIMONIALS */}
        <section aria-label="Testimonials" className="border-t border-white/[.07] py-24">
          <Shell>
        ...
        {/* 7 · FAQ */}
        <section id="faq" className="border-t border-white/[.07] py-24">
          <Shell>
        ...
        {/* 9 · FOOTER */}
        <footer className="border-t border-white/[.08] pb-10 pt-16">
          <Shell>
